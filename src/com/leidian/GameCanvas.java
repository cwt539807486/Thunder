...
public class GameCanvas extends JPanel implements KeyListener {
	...
	private List<Lives> lives = new ArrayList<Lives>();// �������ͼ��
	private List<AddLife> addlife = new ArrayList<AddLife>();// ����+1����
	...
	// �ҷ�
	private Hero hero;
	private List<HeroBullet1> hbul1 = new ArrayList<HeroBullet1>();// �ҷ��ڵ�
	private List<HeroBullet2> hbul2 = new ArrayList<HeroBullet2>();// �ҷ���������

	private background Bg;
	private GameOver gameOver;// ��Ϸ�������ֽ

	private int life = 0;// ����ʧ������Ĵ���������ֵ��
	private int money = 0;
	private int score = 0;
	private int stage = 1;

	private boolean vkUp = false;// hero�������
	...
	public GameCanvas() {
		...
		// boss score>2000ʱ��ˢ���� bossBlood<=0����ʧ
		...
		Thread animate = new Thread() {
			...
			private void addNewEnemy(long time) {
				...
				} else if (score >= 2000 && bossBlood >= 0) {// ��boss
					if (time % 6000 == 0) {
						boss = new Boss(150, 50);
						boss.move(time);
						// С���ж�
	...
	public void paint(Graphics g) {
		...
		g.drawString("money:" + money, 10, 85);
		if (score < 2000)
			g.drawString("stage:" + stage, 10, 110);
		else
			g.drawString("Boss stage", 10, 110);
		...
		if (score >= 2000) {
			if (bossBlood >= 0) {
				...
				g.drawString("bossBlood:", 10, 135);
				g.drawString(bossBlood + "/2000", 10, 160);
			} else {
				g.drawString("Congratulations!", 10, 135);
